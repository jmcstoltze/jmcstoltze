...
**Aplicación web** para generación de códigos QR permanentes con personalización avanzada de colores, tamaño y borde. Incluye interfaz gráfica y línea de comandos.

**Stack**: Python | qrcode | Pillow

🔗 **[Demo en Render](https://qr-generator-on-render.onrender.com/)**
📂 **[Repositorio](https://github.com/jmcstoltze/qr_generator_on_render)**

<div align="center" style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
  <img src="screenshots/qr-generator1.png" alt="Interfaz principal" width="45%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
</div>

### 🔍 Detector de Páginas Duplicadas en PDF (PDF Duplicate Page Detector)

**Plataforma web profesional** que detecta automáticamente páginas duplicadas en PDFs escaneados usando hashing perceptual. Arquitectura dockerizada con Django REST Framework + React + PostgreSQL.

**Stack**: Django REST Framework | React | PostgreSQL | Docker | Docker Compose

📂 **[Repositorio](https://github.com/jmcstoltze/DetectorDuplicadosPDF_WebEdition)**

<div align="center" style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
  <img src="screenshots/pdf-analizer1.png" alt="Vista de subida de PDF" width="45%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
</div>
...
<div align="center" style="margin: 20px 0;">
  ...
  <img src="screenshots/pagina-dashboard.png" alt="Vista Dashboard" width="45%" style="border: 1px solid #ddd; border-radius: 8px; margin: 0 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
</div>
...
<div align="center" style="display: flex; flex-direction: column; gap: 20px; align-items: center;">
  ...
  <img src="screenshots/detalle_libro.jpg" alt="Book Detail Page" style="width: 80%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  
  <img src="screenshots/busqueda.jpg" alt="Search Functionality" style="width: 80%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
</div>
